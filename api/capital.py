...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        #     message = f"The provided location, {dictionary.get('name').upper()}, was not found."
        # elif country_capital:
        #     message = f"The capital of {dictionary.get('name').upper()} is {country_capital}."
        # else:
        #     message = f"{dictionary.get('name').upper()} is the capital of {capital_country}"
